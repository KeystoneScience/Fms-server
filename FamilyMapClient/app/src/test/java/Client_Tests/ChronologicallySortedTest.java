 ...
 */
public class ChronologicallySortedTest {
    ...
    @Test
    public void testBirthFirst() {
        assertEquals(ClientInfo.getInstance().chronologicalEvents(child.getPerson_id()).get(0).getEvent_type(),"birth");
    }

    @Test
    public void testDeathLast() {
        int indexOfLast=ClientInfo.getInstance().chronologicalEvents(child.getPerson_id()).size()-1;
        assertEquals(ClientInfo.getInstance().chronologicalEvents(child.getPerson_id()).get(indexOfLast).getEvent_type(),"death");
    }
